...
> extends HttpClient<SecurityDataType> {
  library = {
     ...
     */
    libraryGetBookById: (id: number, params: RequestParams = {}) =>
      this.request<File, any>({
     ...
     *
     * @tags Library
     * @name LibraryGetGenres
     * @request GET:/library/genres
     */
    libraryGetGenres: (params: RequestParams = {}) =>
      this.request<File, any>({
        path: `/library/genres`,
        method: "GET",
        ...params,
     ...
     *
     * @tags Library
     * @name LibraryGetAuthors
     * @request GET:/library/authors
     */
    libraryGetAuthors: (params: RequestParams = {}) =>
      this.request<File, any>({
